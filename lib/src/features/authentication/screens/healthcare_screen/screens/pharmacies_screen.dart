...
class PahrmaciesScreen extends StatefulWidget {
  const PahrmaciesScreen({Key? key}) : super(key: key);

  @override
  State<PahrmaciesScreen> createState() => _PahrmaciesScreenState();
}

class _PahrmaciesScreenState extends State<PahrmaciesScreen> {
  @override
