...
class EntertainmentSupScreen extends StatefulWidget {
  const EntertainmentSupScreen({Key? key}) : super(key: key);

  @override
  State<EntertainmentSupScreen> createState() => _EntertainmentSupScreenState();
}

class _EntertainmentSupScreenState extends State<EntertainmentSupScreen> {
  @override
